...
[![Android APK](https://img.shields.io/github/v/release/seungyoon-lee29/OREUDA?label=Android%20APK&logo=android&color=3DDC84)](https://github.com/seungyoon-lee29/OREUDA/releases/latest)

**[⬇️ Android APK 다운로드](https://github.com/seungyoon-lee29/OREUDA/releases/latest)** — 설치 후 바로 사용 (iOS는 TestFlight 준비 중)
...
| 서울 19산 · 완등 코스 상시 색칠 | 체크포인트 도착 → 코스 선택 | 산 완등·세트 완성 시 축하 배너 |
