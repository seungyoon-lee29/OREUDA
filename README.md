...
| 데이터 | OSM Overpass 실경로 → PostGIS ETL(`supabase/etl`) 시딩. 산림청 SHP 파이프라인은 로드맵(06) |
...
- ✅ 기록 탭 · "나의 n번째 산" 카운터
- ✅ 산 탐색 검색 · 다크 테마 · 등반 세션(시작→실시간 거리 배너→완등 인증) — v0.5

**비범위(v0)**: 리더보드, 커뮤니티, 사진/공유 카드. 로드맵은 [`docs/01-product-spec.md`](./docs/01-product-spec.md) §5·§9 참조.
